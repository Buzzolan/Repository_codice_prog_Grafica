...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(800, 600, "Texture_1", NULL, NULL);
	...
	glGenTextures(1, &texture); // primo input è quante texture uso, e le carica in un unsigned int dato come secono argomento
	// faccio il bind
    ...
    // ------------------------------------
	Shader ourShader("Capitolo_1/esercizi_texture/4.shader_texture.vs", "Capitolo_1/esercizi_texture/4.4.shader_texture.fs");
